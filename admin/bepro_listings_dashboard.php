...
<div class="wrap about-wrap">
	...
	<div class="changelog">
		...
		<div class="feature-section images-stagger-right">
			...
			<p><?php _e( 'We have introduced a .POT file for those interested in creating their own translations. We will eventually remove all tranlation files, except for the POT file from the plugin. This will reduce the plugin size while still allowing users to create the needed translations. The current po and mo files that we have created, will be moved to the copy of the plugin on github.', "bepro-listings" ); ?></p>
